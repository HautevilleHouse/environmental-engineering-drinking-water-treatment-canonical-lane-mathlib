...
import HautevilleHouse.EnvironmentalEngineeringDrinkingWaterTreatmentCanonicalLaneLean.MathlibObjects
...
def mathlibProofObligation : MathlibProofObligation := {
  ...
  theoremObject := "Water treatment endpoint closure",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedWaterTreatmentClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_water_treatment_endgame A
